...
Un sistema de componentes frontend para el desarrollo de productos para LA NACION. Acompañado por el design system LANA, SHEEP nos provee de todos
los componentes necesarios para la construcción de nuestros productos.

Se encontrarán con el detalle de los componentes y sus hojas de estilo especificas para cada proyecto.
